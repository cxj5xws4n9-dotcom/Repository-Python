    ...
    for char in text:
        if char.isalpha():
            if char in letter_count:
                ...
                letter_count[char] = 1
    return letter_count# TODO Реализуйте функцию
...
def calculate_frequency(letter_count: dict) -> dict:
    ...
    return freq# TODO Реализуйте функцию
...
for letter, freq in frequency_dict.items():
    print(f'{letter}: {freq:.2f}')# TODO Распечатайте в столбик букву и её частоту в тексте
